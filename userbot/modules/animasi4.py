...
@bot.on(poci_cmd(outgoing=True, pattern=r"heu(?: |$)(.*)"))
async def _(typew):
    await typew.edit("▒▒▒▒▒▄██████████▄▒▒▒▒▒\n"
                     "▒▒▒▄██████████████▄▒▒▒\n"
                     "▒▒██████████████████▒▒\n"
...
@bot.on(poci_cmd(outgoing=True, pattern=r"hem(?: |$)(.*)"))
async def _(typew):
    await typew.edit(" ╭━┳━╭━╭━╮╮\n"
                     " ┃┈┈┈┣▅╋▅┫┃\n"
                     " ┃┈┃┈╰━╰━━━━━━╮\n"
...
@bot.on(poci_cmd(outgoing=True, pattern=r"wle(?: |$)(.*)"))
async def _(typew):
    await typew.edit("┈╭━━━━━━━━━━━╮┈\n" 
                     "╭╯┈╭━━╮┈╭━━╮┈╰╮\n" 
                     "┃┈┃┃╭╮┃┈┃╭╮┃┃┈┃\n" 
...
@bot.on(poci_cmd(outgoing=True, pattern=r"peler(?: |$)(.*)"))
async def _(typew):
...
@bot.on(poci_cmd(outgoing=True, pattern=r"ahh(?: |$)(.*)"))
async def _(typew):
