...
@bot.on(poci_cmd(outgoing=True, pattern=r"thanks(?: |$)(.*)"))
async def _(typew):
...
@bot.on(poci_cmd(outgoing=True, pattern=r"malam(?: |$)(.*)"))
async def _(typew):
    await typew.edit("╔═╦═╦╗╔═╦══╦═╦══╗\n"
                     "║═╣═╣║║╬║║║║╬╠╗╔╝\n"
                     "╠═║═╣╚╣║║║║║║║║║\n"
...
@bot.on(poci_cmd(outgoing=True, pattern=r"rumah(?: |$)(.*)"))
async def _(typew):
...
@bot.on(poci_cmd(outgoing=True, pattern=r"join(?: |$)(.*)"))
async def _(typew):
...
@bot.on(poci_cmd(outgoing=True, pattern=r"lari(?: |$)(.*)"))
async def _(typew):
    await typew.edit("──▄█▀█▄─────────██\n"
                     "▄████████▄───▄▀█▄▄▄▄\n"
                     "██▀▼▼▼▼▼─▄▀──█▄▄\n"
...
@bot.on(poci_cmd(outgoing=True, pattern=r"mobil(?: |$)(.*)"))
async def _(typew):
    await typew.edit("──────▄▌▐▀▀▀▀▀▀▀▀▀▀▀▀▌\n"
                     "───▄▄██▌█░░░░░░░░░░░░▐\n"
                     "▄▄▄▌▐██▌█░░░░░░░░░░░░▐\n"
